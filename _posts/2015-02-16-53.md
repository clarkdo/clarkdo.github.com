...
<img class="centered" src="{{ site.baseurl }}public/img/git-model.png" width="575"/>
...
<img width="487" class="centered" src="{{ site.baseurl }}public/img/centr-decentr.png" />\
...
<img class="centered" src="{{ site.baseurl }}public/img/merge-without-ff.png" width="478">
