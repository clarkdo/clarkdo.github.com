...
<p class="centered"><img class="centered" src="{{ site.baseurl }}public/img/git-model.png" width="575"/></p>
...
<p class="centered"><img class="centered" width="487" src="{{ site.baseurl }}public/img/centr-decentr.png" /></p>
...
<p class="centered"><img class="centered" src="{{ site.baseurl }}public/img/merge-without-ff.png" width="478"></p>
