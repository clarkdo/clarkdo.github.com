...
<body>
    <script id="tpl" type="text/x-handlebars-template">
        <div class="demo">
            <h1>{{page.open}}name{{page.close}}</h1>
            <p>{{page.open}}content{{page.close}}</p>
        </div>
    </script>
</body>
</html>
...
<body>
    <script id="tpl" type="text/x-handlebars-template">
        <ul>
            {{page.open}}#tools{{page.close}}
            <li>{{page.open}}lib{{page.close}}</li>
            {{page.open}}/tools{{page.close}}
        </ul>
    </script>
</body>
...
<body>
    <script type="text/template" id="tpl">
        <ul>
            {{page.open}}#each items{{page.close}}
            <li>{{page.open}}agree_button{{page.close}}</li>
            {{page.open}}/each{{page.close}}
        </ul>
    </script>
</body>
</html>
